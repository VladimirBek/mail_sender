...
from .views import IndexView, ClientsList, ClientDetail, ClientCreate, ClientUpdate, ClientDelete, MailingLists, \
    MailingDetail, SettingsCreate, MailingUpdate, MailingDelete, MailList, MailDetail, MailCreate, MailUpdate, MailDelete
...
urlpatterns = [
    ...
    path('mailing_create/', SettingsCreate.as_view(), name='mailing_create'),
